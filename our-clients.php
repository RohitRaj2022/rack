    ...
    <style>
        @media screen and (min-width:998px) {
            ...
            .client-card {
                ...
                border-radius: 12px;
                padding: 20px;
                box-shadow: 0 4px 12px rgb(30 8 8 / 26%);
...
<body>
    ...
    <section class="client-section">
        ...
        <div class="client-grid">
            <div class="client-card">
                <img src="./build/assets/images/clients/vishalmegamart.webp" alt="Client 1" />
                <h4>Vishal Megamart</h4>
                <p>Retail Partner</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/haldiram.webp" alt="Client 2" />
                <h4>haldiram</h4>
                <p>Distributor</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/reliancedigital.webp" alt="Client 3" />
                <h4>Reliance Digital</h4>
                <p>Franchise Partner</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/Reliancefresh.webp" alt="Client 4" />
                <h4>Reliance Fresh</h4>
                <p>OEM Client</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/24seven.webp" alt="Client 5" />
                <h4>24 Seven</h4>
                <p>Channel Partner</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/guardian-pharmacy.webp" alt="Client 6" />
                <h4>Gardian Pharmacy</h4>
                <p>Export Client</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/health-n-glow.webp" alt="Client 6" />
                <h4>Health & Glow</h4>
                <p>Export Client</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/lloydimg.webp" alt="Client 6" />
                <h4>LLOYD</h4>
                <p>Export Client</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/spencers.webp" alt="Client 6" />
                <h4>Spencer's</h4>
                <p>Export Client</p>
            </div>

            <div class="client-card">
                <img src="./build/assets/images/clients/moremegastore.webp" alt="Client 6" />
                <h4>More Megamart</h4>
                <p>Export Client</p>
            </div>
            <div class="client-card">
                <img src="./build/assets/images/clients/liberty.webp" alt="Client 6" />
                <h4>Liberty</h4>
                <p>Export Client</p>
            </div>
    ...
    <section class="bottom-supports footer-mobile">
        <div class="supports">
            <div class="call">
                <div class="footer-mobile">
                    <a href="tel:+918882668343">
            ...
            <div class="whatsapp">
                <a href="https://api.whatsapp.com/send?phone=+918882668343&text=Hello">
