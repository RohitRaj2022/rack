...
s1.async=true;
s1.src='https://embed.tawk.to/6887bf42fda625192826aac6/1j19467ad';
s1.charset='UTF-8';
...
<!--End of Tawk.to Script-->
    ...
    <footer class="footer">
        <div class="footer-left">
            ...
            <p>At Global Steel hub, we specialize in manufacturing high-quality display racks tailored for retail stores, supermarkets, warehouses, and showrooms. </p>
            <div class="socials">
  ...
  <ul class="box">
    ...
    <li><a href="#"><i class="fas fa-map-marker-alt"></i> : D 94, Nanhey Park, Uttam Nagar, Matiala, New Delhi, Delhi, 110059</a></li>
